...
<?php
$forma ='
<form name="form" method="POST" action="brisanje.php">
    <div class="container-fluid">
        <div class="row">
            <label for="naslov">Upiši naslov članka koji želiš obrisati (mora biti prisutan u tablici):</label>
        </div>
        <div class="row">    
...
if ($_SESSION["username"]=="" && $_SESSION["password"]==""){
    echo "Prvo se morate registrirati";
}
else if ($_SESSION["admin"] == 0){
    echo "Bok! Uspješno ste prijavljeni, ali niste admin!";
}
